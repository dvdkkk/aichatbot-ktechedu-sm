  ...
  return (
    <section id="vision" className="py-24 bg-black relative border-b border-zinc-900 overflow-hidden">
      <div className="container mx-auto px-4 flex flex-col items-center text-center">
        ...
        <div ref={chartRef} className="w-full max-w-xl mx-auto mb-20 px-4 relative">
          <Reveal delay={200} className="mb-12">
            <h3 className="text-zinc-400 text-sm font-black uppercase tracking-[0.2em]">
              국내 기업 챗봇 도입 수요 예측
            </h3>
          </Reveal>

          <div className="relative h-80 flex items-end justify-center gap-16 md:gap-24 border-b-2 border-zinc-800 pb-4">
            
            {/* 2021 Bar */}
            <div className="flex flex-col items-center gap-4 w-24 z-10">
              <div className="relative w-full">
                <div 
                  className={`w-full bg-zinc-800 rounded-t-xl transition-all duration-1000 ease-out origin-bottom`}
                  style={{ height: startAnimate ? '45px' : '0px' }}
                >
                  <span className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-zinc-500 text-xs font-black transition-opacity duration-500 delay-1000 ${startAnimate ? 'opacity-100' : 'opacity-0'}`}>
                    5.6%
                  </span>
                </div>
              </div>
              <span className="text-zinc-500 text-sm font-bold tracking-tighter">2021년</span>
            </div>
              ...
              <div className="relative w-full">
                ...
                <div className={`absolute -top-16 left-1/2 -translate-x-1/2 opacity-0 ${startAnimate ? 'animate-pop-in delay-[1.2s]' : ''}`}>
                  <div className="flex flex-col items-center">
                    <span className="text-yellow-400 text-6xl font-black italic tracking-tighter text-shine">
                ...
                <div 
                  className={`w-full bg-gradient-to-t from-yellow-600 via-yellow-400 to-yellow-200 rounded-t-xl transition-all duration-1000 ease-out origin-bottom shadow-[0_0_60px_rgba(251,191,36,0.3)]`}
        ...
        <Reveal delay={500} className="space-y-8 max-w-3xl">
          <p className="text-zinc-400 text-lg md:text-2xl font-medium leading-relaxed break-keep px-4">
          ...
          <div className="pt-6">
            <h4 className="text-3xl md:text-6xl font-black text-white tracking-tight">
              비전공자도 경력자로!<br />
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full pointer-events-none overflow-hidden -z-10">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-yellow-400/5 rounded-full blur-[140px]"></div>
      </div>
    </section>
  );
};